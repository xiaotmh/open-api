(function ($) {
    ...
    _proto.initDOM = function () {
        ...
        var refreshIcon = createElement('i', 'layui-icon layui-icon-refresh-1 ');
        //var refreshIcon = createElement('i', 'layui-icon-refresh-1 ' + this.options.repeatIcon);
    ...
    _proto.initImg = function () {
        ...
        img.setSrc = function () {
            ...
            if (!src || src === '') src = '/slidingValidation/img/ve.jpg' ;
